    ...
    if(session) {
        return (
            <div className='h-full bg-white sm:h-full'>
                ...
                <div className='relative block pt-36 lg:w-2/4 mx-auto'>
                    <div className='text-left font-regular text-lg rounded-md bg-blue-700 p-2 text-white'>
                        <p><Image src="/ico/config.svg" height={18} width={18} alt="log-out" className='inline-block mx-auto mr-2 mb-1 invert'></Image>Configuración</p>
                    </div>
                    <div className='mt-2'>
                        <Link href="/config/general"><button className='w-full bg-gray-50 mt-2 p-2 rounded-md border-black hover:bg-blue-500 hover:text-white text-left'>Datos generales</button></Link>
                        <Link href="/config/virtual"><button className='w-full bg-gray-50 mt-2 p-2 rounded-md border-black hover:bg-blue-500 hover:text-white text-left'>Tienda virtual</button></Link>
                    </div>
